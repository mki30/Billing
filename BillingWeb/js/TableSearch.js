var FilterTableTimeOut = null;

$(function ()
{
    $("#txtSearch").on("keyup", function (e)
    {
        if (FilterTableTimeOut)
            clearTimeout(FilterTableTimeOut);

        FilterTableTimeOut = setTimeout("FilterTable()", 500);
...
{
    var txt = $("#txtSearch").val().toUpperCase();
    
    $("#DataTable").css("display", "none"); // hide table to speed up rendering
